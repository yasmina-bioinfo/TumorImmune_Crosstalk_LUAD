...
# TAMs priority: IFN-stimulated, Stress-response, SPP1+, 
...
# ============================================================
# 2) Cells of interest — guided by Blocs 3 and 4
# ============================================================

# CD8 priority: TEX and TPEX only
cd8_poi <- c("CD8.TEX", "CD8.TPEX")

# TAMs priority: 5 discriminant subtypes
tam_poi_raw <- c(
...
# ============================================================
# 4) Generate preprint figures — cells of interest only
# ============================================================
message("Generating preprint figures — cells of interest...")

# Figure 1 — CD8.TEX/TPEX -> TAMs (priority)
...
ggsave(file.path(OUT_FIG, "Bloc5_02b_LIANA_CD8_TAMs_preprint.png"),
       p1, width = 14, height = 10, dpi = 300, bg = "white")
message("Saved: CD8 -> TAMs preprint")

# Figure 2 — TAMs (priority) -> CD8.TEX/TPEX
...
ggsave(file.path(OUT_FIG, "Bloc5_02b_LIANA_TAMs_CD8_preprint.png"),
       p2, width = 14, height = 10, dpi = 300, bg = "white")
message("Saved: TAMs -> CD8 preprint")

# Figure 3 — CD8.TEX/TPEX -> Epithelial (all)
...
ggsave(file.path(OUT_FIG, "Bloc5_02b_LIANA_CD8_Epithelial_preprint.png"),
       p3, width = 14, height = 10, dpi = 300, bg = "white")
message("Saved: CD8 -> Epithelial preprint")

# Figure 4 — Epithelial (all) -> CD8.TEX/TPEX
...
ggsave(file.path(OUT_FIG, "Bloc5_02b_LIANA_Epithelial_CD8_preprint.png"),
       p4, width = 14, height = 10, dpi = 300, bg = "white")
message("Saved: Epithelial -> CD8 preprint")

# Figure 5 — TAMs (priority) -> Epithelial (all)
...
ggsave(file.path(OUT_FIG, "Bloc5_02b_LIANA_TAMs_Epithelial_preprint.png"),
       p5, width = 14, height = 10, dpi = 300, bg = "white")
message("Saved: TAMs -> Epithelial preprint")

# Figure 6 — Epithelial (all) -> TAMs (priority)
...
ggsave(file.path(OUT_FIG, "Bloc5_02b_LIANA_Epithelial_TAMs_preprint.png"),
       p6, width = 14, height = 10, dpi = 300, bg = "white")
message("Saved: Epithelial -> TAMs preprint")
