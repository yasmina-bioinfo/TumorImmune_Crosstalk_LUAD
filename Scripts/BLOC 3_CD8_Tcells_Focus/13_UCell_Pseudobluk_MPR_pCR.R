#!/usr/bin/env Rscript
# ============================================================
# GSE243013 : Bloc3 Script 13: Pseudobulk UCell scores MPR vs pCR — CD8 T cells
...
#         Results/Tables/Bloc3_pseudobulk_CD8_MPR_pCR_scores.csv
# ============================================================
...
IN_OBJ <- file.path(DATA_DIR, "Objects/Bloc3_11_seu_CD8_UCell.rds")
OUT_FIG  <- file.path(DATA_DIR, "Results/Figures/CD8")
OUT_TAB  <- file.path(DATA_DIR, "Results/Tables")

# 1) Load UCell CD8 object
message("Loading UCell CD8 object...")
seu_CD8 <- readRDS(IN_OBJ)
message("Cells: ", ncol(seu_CD8))

# 2) Define score columns
score_cols <- c("Exhaustion_UCell", "Cytotoxicity_UCell",
                "TPEX_UCell", "Memory_UCell")
...
fwrite(as.data.frame(pseudobulk),
       file.path(OUT_TAB, "Bloc3_pseudobulk_CD8_MPR_pCR_scores.csv"))
message("Saved: Bloc3_pseudobulk_CD8_MPR_pCR_scores.csv")
