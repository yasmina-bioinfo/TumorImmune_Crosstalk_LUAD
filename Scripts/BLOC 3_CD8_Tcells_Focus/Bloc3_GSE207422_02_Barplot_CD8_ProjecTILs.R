#!/usr/bin/env Rscript
# ============================================================
# GSE207422: Bloc3_GSE207422 Script 02: Barplot CD8 ProjecTILs states
# Proportions of CD8 functional states by pathological response
# Input:  Objects/Bloc3_08_seu_CD8_ProjecTILs.rds
# Output: Results/Figures/CD8/Bloc3_GSE207422_Barplot_CD8_ProjecTILs.png
#         Results/Tables/Bloc3_GSE207422_CD8_chisq_test.csv
#         Results/Tables/Bloc3_GSE207422_CD8_fisher_posthoc.csv
# ============================================================
...
cont_table <- table(seu_CD8$functional.cluster, seu_CD8$PathResponse)

# Chi-2 global
#"Note: proportions based on ProjecTILs functional.cluster annotation (Script 01).\nChi-2 p-value computed on GSE207422 (n=13); higher p-value reflects smaller cohort size and subtler proportional differences compared to GSE243013 (n=63, p < 2.2e-16)."
...
fwrite(chisq_summary, file.path(OUT_TAB, "Bloc3_GSE207422_CD8_chisq_test.csv"))
message("Saved: Bloc3_GSE207422_CD8_chisq_test.csv")
...
print(fisher_df)
fwrite(fisher_df, file.path(OUT_TAB, "Bloc3_GSE207422_CD8_fisher_posthoc.csv"))
message("Saved: Bloc3_GSE207422_CD8_fisher_posthoc.csv")
