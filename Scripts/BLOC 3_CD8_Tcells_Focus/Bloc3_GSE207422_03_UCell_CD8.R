...
# ============================================================
# 12) Preprint figures : MPR vs NMPR with Wilcoxon p-values
...
# Subset TEX and TPEX, MPR and NMPR only
...
ggsave(file.path(OUT_FIG_PREPRINT, "Bloc3_GSE207422_UCell_CD8_TEX_TPEX_MPR_NMPR_pvalues.png"),
       p_preprint, width = 16, height = 10, dpi = 300, bg = "white")

message("Saved: Bloc3_GSE207422_UCell_CD8_TEX_TPEX_MPR_NMPR_pvalues.png")
message("DONE Bloc3_GSE207422 Script 03 — preprint figures added")
